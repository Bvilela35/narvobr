...
export function calcFocus(inputs: FocusInputs): FocusResult {
  const { rendaMensal, horasDia, interrupcoes } = inputs;
  ...
  // Productivity hours
  const horasPerdidasDia = horasDistracoes;
