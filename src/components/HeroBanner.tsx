...
export function HeroBanner() {
  ...
  return (
    <section ref={sectionRef} <section ref={sectionRef} className="relative min-h-[120vw] md:min-h-[85vh] flex items-end overflow-hidden"> flex items-end overflow-hidden">
      <motion.img
        src={heroBanner}
